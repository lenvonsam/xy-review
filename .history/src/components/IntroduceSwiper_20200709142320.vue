<template lang="pug">
  swiper(:options="swiperOption", ref="mySwiper", style="width: 100%")
    swiper-slide(:style="{height: screenHeight + 'px'}") 111111111
      .banner-bg.box.full-width.relative.slide-introduce1-bg.relative
    ...
    swiper-slide(:style="{height: screenHeight + 'px'}") 222222222
