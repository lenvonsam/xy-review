    ...
    swiper-slide
      .banner-bg.box.full-width.relative.slide-join-bg.relative(:style="{height: screenHeight + 'px'}")
        ...
        .mt-20(style="display: flex;flex-direction: column;")
          .ml-28.formword-style.text-bold 公司名称
          .ml-28input(value="", placeHolder="请输入公司名称")
          .ml-28.formword-style.text-bold 联系电话
          .ml-28input(value="", placeHolder="请输入联系电话")
          .ml-28.formword-style.text-bold 经营性质
          .ml-28div.ml-23l(style="display: flex;flex-direction: row;")
            label.ml-23(v-for="check,index in radioGroup", :key="index",style="display: flex;flex-direction: row;")
              input.checkbox-style(type="checkbox")
              span.text-white.fs-13.lh-33.ml-2 {{check.name}}
          button.comfirm-btn 确认
    swiper-slide
      IntroduceSwiper
    swiper-slide
