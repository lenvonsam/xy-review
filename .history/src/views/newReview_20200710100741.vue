...
.part-sec
  padding-top 10%
  &.one
    background -webkit-image-set(url('http://xymobile.xingyun361.com/fubkg.png') 2x)
  &.sec
    background -webkit-image-set(url('http://xymobile.xingyun361.com/wenbkg.png') 2x)
  &.third
    background -webkit-image-set(url('http://xymobile.xingyun361.com/shuangbkg.png') 2x)
  &.forth
