  ...
  swiper.swipper.full-width(:options="swiperOption", ref="xySwiper", @slideChange="slideTouchChange")
    swiper-slide
      .banner-bg.box.full-width.relative.slide-introduce1-bg.relative(:style="{height: screenHeight + 'px'}")
        img.introduceframe-style(src="http://xymobile.xingyun361.com/introduceframe.png")
        span sfasifasfa
        img.introduceframe2-style(src="http://xymobile.xingyun361.com/introduceframe2.png")
    swiper-slide
