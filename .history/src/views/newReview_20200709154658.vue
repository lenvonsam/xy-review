  ...
  swiper.swipper.full-width(:options="swiperOption", ref="xySwiper", @slideChange="slideTouchChange")
    swiper-slide
      .banner-bg.box.full-width.relative.slide-join-bg.relative(:style="{height: screenHeight + 'px'}")
        ...
        .mt-15.chinese-style(class="animated bounceInRight") 我们诚邀
        .mt-10.english-style(class="animated bounceInRight") We sincerely invitel
    swiper-slide
      IntroduceSwiper
    swiper-slide
...
.slide-introduce1-bg
  ...
  .introduceframe2-style
    ...
    background-repeat no-repeat
.slide-join-bg
  background -webkit-image-set(url('http://xymobile.xingyun361.com/joinbkg.png') 2x)
  .jointext-style
    background -webkit-image-set(url("http://xymobile.xingyun361.com/jointext.png") 1x)
    background-repeat no-repeat
    background-size contain
    width vm(308)
    height vm(78)
